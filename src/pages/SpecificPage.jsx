    ...
    <div className="grid grid-cols-[2fr_3fr] bg-[#F5BDBC]">
      <div>
        ...
        <div className="flex flex-col text-center items-center">
          ...
          <div className="bg-[#79A2DC] w-80 text-3xl py-6 rounded-full text-medium text-white text-center mb-24">Specific meeting</div>
          ...
          <form className="flex flex-col gap-16" onSubmit={handleSubmit}>
            <div className="">
              <div className="flex gap-4 items-center mb-6">
                ...
                <img src={nextHeaderImg} alt="" className="h-8" />
              </div>
              <input
                  type="text"
                  name="name"
